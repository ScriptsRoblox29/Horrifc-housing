        ...
        if Value then
            task.spawn(function()
                ...
                local function startAutoWin()
                    ...
                    platform.Position = Vector3.new(112.34626770019531, 999.0631103515625, 1208.48876953125)
                    ...
                    while getgenv().autoWin do
                        ...
                        for _, plr in ipairs(game.Players:GetPlayers()) do
                            if plr ~= player and plr.Team and plr.Team.Name == "Playing" and plr.Character and plr.Character:FindFirstChild("HumanoidRootPart") then
                                table.insert(targets, plr)
                            end
                        end

                        for _, target in ipairs(targets) do
                            if target and target.Character and target.Character:FindFirstChild("HumanoidRootPart") and target.Team and target.Team.Name == "Playing" then
                                local targetHRP = target.Character.HumanoidRootPart
                                while target.Team and target.Team.Name == "Playing" and getgenv().autoWin and (targetHRP.Position - hrp.Position).Magnitude < 300 do
                                    hrp.CFrame = CFrame.new(targetHRP.Position) * CFrame.new(0, 0, 3) * CFrame.Angles(0, math.rad(720), 0)
                                    task.wait(0.02)
                                    hrp.CFrame = CFrame.new(targetHRP.Position) * CFrame.new(0, 0, -3) * CFrame.Angles(0, math.rad(720), 0)
                                    task.wait(0.02)
                                end
                        ...
                        task.wait(0.2) -- Espera antes de checar novos jogadores
                    end
